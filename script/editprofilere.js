...
const editprofilecompany = document.querySelector('.editprogile__company');
    ...
    if (user) {
        ...
        if (docSnap.exists()) {
            ...
            if (editprofilename) {
                ...
                if (data.company) {
                    editprofilecompany.placeholder = data.company; 
                } else{
                    editprofilecompany.placeholder = "Agrega la compañía a la que perteneces";
                }
...
btn.addEventListener('click', function (event) {
    ...
    const company = editprofile.company.value
            ...
            if (docSnap.exists()) {
                ...
                if (userInfo) {
                    await updateDoc(doc(db, "users", uid), {
                        ...
                        .then(function () {
                            window.location.href = 'profilere.html';
                        });
                }
